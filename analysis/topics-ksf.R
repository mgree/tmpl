...
basepath = "/Users/kfisher/work/tmpl/esaprog"
ppath = file.path(basepath, "../raw/abs/icfp/ICFP 1996")
#ppath = file.path(basepath, "eco.confex.com/eco/2015/webprogram")
#ppath ="/Users/kfisher/work/tmpl/esaprog/eco.confex.com/eco/2015/webprogram"
paper_files = list.files(ppath, recursive=TRUE, pattern="\\d+\\.txt")
...
# }, .progress = "time")
abs = alply(paper_files, 1, function(paper) {
  text <- readLines(file.path(ppath, paper))
  return(text)
}, .progress = "time")
